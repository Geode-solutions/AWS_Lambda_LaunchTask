def load_config(
    ...
    CONFIG = {
        'SECURITY_GROUP': 'sg-06cb4bf993f4ccb26', 'SUBNET_ID': 'subnet-0882d674b17515f6a', 'VPC_ID': 'vpc-0e58c4d6976fb2aac', 'SECONDS_BETWEEN_TRIES': 0.25, 'HEALTHCHECK_PORT': 5000, 'TOOLS_CONFIG':
            {
                'LISTENER_ARN': 'arn:aws:elasticloadbalancing:eu-west-3:622060531233:listener/app/ApiGeodeSolutions/4a4814e5912d42aa/70716e78eabafa1f', 'TOOLS_PROD_CONFIG':
                    {
            ...
            {
                'LISTENER_ARN': 'arn:aws:elasticloadbalancing:eu-west-3:622060531233:listener/app/Api2GeodeSolutions/fd4af85f9ffc5a54/b559795c939115f4', 'SHARETWIN_PROD_CONFIG':
                    {
    ...
    if '/tools/' in REQUEST_PATH:
        ...
        if REQUEST_ORIGIN == 'https://geode-solutions.com':
            ...
            raise functions.make_lambda_return(403, '403 Forbidden', '', {
        ...
        if REQUEST_ORIGIN == 'https://geode-solutions.com':
            ...
            raise functions.make_lambda_return(403, '403 Forbidden', REQUEST_ORIGIN, {
                                               'error_message': 'Domain not allowed!'})
